...
static LV2UI_Handle instantiate(const struct _LV2UI_Descriptor * descriptor,
	...
	ui->controls[1] = { 0.0, 0.0, -12.0, 6.0, 0.1, 120, 60, 61, 61, false,"GAIN", KNOB, GAIN};
	ui->controls[2] = { 0.0, 0.0, 0.0, 1.0, 1.0, 190, 60, 61, 61, false,"DRIVE", SWITCH, DRIVE};
	ui->controls[3] = { 0.0, 0.0, 0.0, 2.0, 1.0, 260, 60, 61, 61, false,"TONE", ENUM, TONE};

	ui->controls[4] = { 5.0, 5.0, -6.0, 20.0, 0.2, 50, 160, 61, 61, false,"PEAK", KNOB, PEAK};
	ui->controls[5] = { 1.0, 1.0, 0.0, 1.0, 0.01, 120, 160, 61, 61, false,"DEPTH", KNOB, DEPTH};
	ui->controls[6] = { 0.0, 0.0, 0.0, 1.0, 1.0, 190, 160, 61, 61, false,"RANGE", SWITCH, RANGE};
	ui->controls[7] = { 0.0, 0.0, 0.0, 2.0, 1.0, 260, 160, 61, 61, false,"MODE", ENUM, MODE};
